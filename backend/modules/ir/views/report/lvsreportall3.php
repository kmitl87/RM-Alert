...
$this->title = 'รายงานอุบัติการณ์ประเภทความเสี่ยงทางคลินิกเฉพาะโรค แยกตามระดับความรุนแรง ปี ' . $y;
?>
...
<div class="incidentreport-view"><div class="box box-primary box-solid">
        ...
        <div class="box-body">
            <p>
                <?= Html::a('เดือนก่อนหน้า', ['lvsreportall4'], ['class' => 'btn btn-default']) ?>
                <?= Html::a('เดือนถัดไป', ['lvsreportall2'], ['class' => 'btn btn-default']) ?>
