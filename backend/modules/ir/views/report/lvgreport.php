...
$this->title = 'รายงานอุบัติการณ์ประเภทความเสี่ยงทั่วไป แยกตามระดับความรุนแรง เดือน'. $month;
...
<div class="incidentreport-view"><div class="box box-primary box-solid">
        ...
        <div class="box-body">
            <p>
                <?= Html::a('เดือนก่อนหน้า', ['lvgprev'], ['class' => 'btn btn-default']) ?>
                <?= Html::a('เดือนถัดไป', ['lvgnext'], ['class' => 'btn btn-default'])?>
            </p>
