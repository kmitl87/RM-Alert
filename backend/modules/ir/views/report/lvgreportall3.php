...
$this->title = 'รายงานอุบัติการณ์ประเภทความเสี่ยงทั่วไป แยกตามระดับความรุนแรง ปี ' . $y;
?>
...
<div class="incidentreport-view"><div class="box box-primary box-solid">
        ...
        <div class="box-body">
            <p>
                <?= Html::a('ปีก่อนหน้า', ['lvgreportall4'], ['class' => 'btn btn-default']) ?>
                <?= Html::a('ปีถัดไป', ['lvgreportall2'], ['class' => 'btn btn-default']) ?>
