...
$this->title = 'รายงานอุบัติการณ์ประเภทความเสี่ยงทางคลินิกทั่วไป แยกตามระดับความรุนแรง เดือน'. $month;
...
<div class="incidentreport-view"><div class="box box-primary box-solid">
        ...
        <div class="box-body">
            <p>
                <?= Html::a('เดือนก่อนหน้า', ['lvcprev'], ['class' => 'btn btn-default']) ?>
                <?= Html::a('เดือนถัดไป', ['lvcnext'], ['class' => 'btn btn-default'])?>
            </p>
