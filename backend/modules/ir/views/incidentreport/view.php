...
<div class="box box-warning box-solid">
    ...
    <div class="box-body">
        ...
        <p>
            ...
            <?=
            Html::a('พิจารณาแล้ว', ['accept', 'id' => $model->irID], [
                'class' => 'btn btn-success',
                'data' => [
                    'confirm' => 'คุณได้ทำการพิจารณาใบ IR นี้แล้ว [ใช่หรือไม่] ?',
                    'method' => 'post',
                ],
            ])
            ?>
            <?= Html::a('<class="box-title"><i class="glyphicon glyphicon-print"></i> พิมพ์ใบทบทวน', ['print', 'id' => $model->irID], ['class' => 'btn btn-primary']) ?>
        </p>
