...
$this->title = 'การรายงานอุบัติการณ์';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="box box-warning box-solid">
    <div class="box-header">
        <h3 class="box-title"><i class="fa fa-file-text"></i>  <?= Html::encode($this->title) ?>ของ (รหัสผู้ใช้งาน : <?= Html::encode(Yii::$app->user->identity->username) ?>)</h3>
    </div>
    <div class="box-body">
                    ...
                    'template' => '{view} {update}',
                     'buttons'=>[
                                    'view' => function($url,$model,$key){
                                        return Html::a('<i class="glyphicon glyphicon-eye-open"></i>',['incidentreport/userview','id'=>$model->irID]);
                                    }
                            ]
